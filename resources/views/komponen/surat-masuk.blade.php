                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <select id="id_pegawai" name="id_pegawai[]"
                                                ...
                                                @foreach ($pegawai as $p)
                                                    <option value="{{ $p->id }}">{{ $p->nama_pegawai }} -
                                                        {{ $p->nama_jabatan }}</option>
                                                @endforeach
                                            </select>
                        ...
                        @forelse($suratMasuk as $index => $surat)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <form action="{{ route('komponen.hapus-data', $surat->id) }}" method="POST"
                                        class="d-inline">
                                        @csrf
                                        @method('DELETE')
...
@push('scripts')
    <!-- jQuery (jika belum tersedia di layout master) -->
    ...
    <script>
        $(document).ready(function() {
            // Inisialisasi DataTables untuk tabel surat masuk
            ...
            // Re-inisialisasi Select2 dalam modal
