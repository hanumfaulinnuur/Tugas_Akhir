            ...
            <div class="card my-4 p-4">
              ...
              <!-- Modal Tambah -->
                <div class="modal fade" id="modalTambahSurat" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
                    ...
                    <div class="modal-dialog modal-lg"> <!-- Tambah modal-lg agar lebih lebar -->
                        <div class="modal-content">
                            <form action="{{ route('komponen.tambah.surat') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="modal-body">
                                    <div class="row g-3"> <!-- Gunakan grid dan spacing -->
                                        <div class="col-md-6">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <select id="id_pegawai" name="id_pegawai[]" class="form-select" multiple required>
